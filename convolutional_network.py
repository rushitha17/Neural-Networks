...
def model_fn(features, labels, mode):
    ...
    loss_op = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits_v2(logits=logits_train, labels=labels))
...
# Train the Model
model.train(input_fn= input_fn_train, steps=num_steps)
